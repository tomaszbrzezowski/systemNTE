/*
  # Fix agreements table structure
  
  1. Changes
    - Drop and recreate agreements table with proper structure
    - Add proper triggers and constraints
    - Fix RLS policies
    
  2. Security
    - Enable RLS
    - Add policies for administrators and users
*/
...
-- Create function to set agreement number
...
-- Create trigger for agreement number
