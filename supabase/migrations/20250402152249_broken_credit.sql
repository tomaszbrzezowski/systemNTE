/*
  # Fix FOR loop null error in hall layout saving
  
  1. Changes
    - Update the update_hall_seats function to handle null row_seats arrays
    - Add null checks before using array_length function
    - Ensure empty_rows is never null
    - Fix the calculate_section_seats helper function
