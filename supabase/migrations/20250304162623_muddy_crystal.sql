/*
  # Update coordinates for Polish cities

  1. Updates
    - Sets precise coordinates for Polish cities
    - Updates any missing coordinates to Poland's center point
    
  2. Changes
    - Updates latitude and longitude for all major Polish cities
    - Ensures all cities have valid coordinates
*/
